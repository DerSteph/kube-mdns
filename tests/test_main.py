...
class TestMain(unittest.TestCase):
    ...
    @patch("src.storage.storage_service.StorageService")
    @patch("src.kubernetes_utils.kubernetes_factory.KubernetesFactory.create")
    def test_main_success(self, kubernetes_factory, storage_service, zc_factory, kw_factory, core_service):
    ...
    @patch("src.storage.storage_service.StorageService")
    @patch("src.kubernetes_utils.kubernetes_factory.KubernetesFactory.create") 
    def test_main_throws_exception(self, kubernetes_factory, storage_service, zc_factory, kw_factory, core_service):
        kubernetes_service = Mock(spec=KubernetesService)
